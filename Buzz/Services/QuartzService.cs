...
public class QuartzService
{
    ...
    private readonly WorkingDayCheckService _workingDayCheckService;

    public QuartzService(ISchedulerFactory schedulerFactory, WorkingDayCheckService workingDayCheckService)
    {
